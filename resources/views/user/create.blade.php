                ...
                <form action="{{ route('user.store') }}" method="POST" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" class="input-modern pl-10 @error('email') border-red-400 @enderror" placeholder="kasir@laundry.com" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" class="input-modern pl-10 @error('password') border-red-400 @enderror" placeholder="Min. 8 karakter" minlength="8" required>
                        </div>
